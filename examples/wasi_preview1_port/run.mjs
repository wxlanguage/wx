...
//
//   cargo run -p wx-cli -- compile examples/wasi_preview1_port/main.wx
//   mv main.wasm examples/wasi_preview1_port/main.wasm
//   node examples/wasi_preview1_port/run.mjs
